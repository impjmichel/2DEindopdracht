...
public class AdvancedControlPanel extends GameLevel implements ActionListener
{
	private static final long	serialVersionUID	= 1L;
	private String[] s = {"Game controls:","+ UP/DOWN","move left","move right","switch gravity","interact (enter)","Back","+ ENTER"};
	private int select, maxSelect;
	private ArrayList<Shape> shapes;
	private Timer timer;
	private boolean prevKeybinding;
	
	public AdvancedControlPanel(GameWorld world, GameFrame frame)
	{
		super(world,frame);
		select = 0;
		maxSelect = 5;
